 ...
 * @subpackage Piwik_Db
 */
class Piwik_Db_Schema_Sqlite implements Piwik_Db_Schema_Interface
{
	/**
	...
	{
		return self::hasStorageEngine('SQLite');
	}
	...
	public function getTablesCreateSql()
	{
		...
		$tables = array(
			...
			'site' => "CREATE TABLE {$prefixTables}site (
						  idsite INTEGER(10) UNSIGNED NOT NULL AUTOINCREMENT,
			...
			'logger_message' => "CREATE TABLE {$prefixTables}logger_message (
									  idlogger_message INTEGER UNSIGNED NOT NULL AUTOINCREMENT,
			...
			'logger_api_call' => "CREATE TABLE {$prefixTables}logger_api_call (
									  idlogger_api_call INTEGER UNSIGNED NOT NULL AUTOINCREMENT,
			...
			'logger_error' => "CREATE TABLE {$prefixTables}logger_error (
									  idlogger_error INTEGER UNSIGNED NOT NULL AUTOINCREMENT,
									  timestamp TIMESTAMP NULL,
									  message TEXT NULL,
			...
			'logger_exception' => "CREATE TABLE {$prefixTables}logger_exception (
									  idlogger_exception INTEGER UNSIGNED NOT NULL AUTOINCREMENT,
									  timestamp TIMESTAMP NULL,
									  message TEXT NULL,
									  errno INTEGER UNSIGNED NULL,
									  errline INTEGER UNSIGNED NULL,
			...
			'log_action' => "CREATE TABLE {$prefixTables}log_action (
									  idaction INTEGER(10) UNSIGNED NOT NULL AUTOINCREMENT,
									  name TEXT,
			...
			'log_visit' => "CREATE TABLE {$prefixTables}log_visit (
							  idvisit INTEGER(10) UNSIGNED NOT NULL AUTOINCREMENT,
							  idsite INTEGER(10) UNSIGNED NOT NULL,
			...
			'log_link_visit_action' => "CREATE TABLE {$prefixTables}log_link_visit_action (
											  idlink_va INTEGER(11) UNSIGNED NOT NULL AUTOINCREMENT,
									          idsite int(10) UNSIGNED NOT NULL,
									  		  idvisitor BINARY(8) NOT NULL,
									          server_time DATETIME NOT NULL,
											  idvisit INTEGER(10) UNSIGNED NOT NULL,
	...
	public function getTablesInstalled($forceReload = true)
	{
			...
			|| $forceReload === true)
		{
			...
			$allTables = $db->fetchCol("SELECT name FROM sqlite_master WHERE type='table' AND name LIKE '".$prefixTables."%'");
			...
			$allArchiveNumeric = $db->fetchCol("SELECT name FROM sqlite_master WHERE type='table' AND name LIKE '".$prefixTables."archive_numeric%'");
			$allArchiveBlob = $db->fetchCol("SELECT name FROM sqlite_master WHERE type='table' AND name LIKE '".$prefixTables."archive_blob%'");
